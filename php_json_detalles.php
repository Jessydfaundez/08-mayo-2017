...
<p>La humedad ambiental es: <?php echo round($datos["data"]["sensors"][2]["value"],2);?> <?php echo ($datos["data"]["sensors"][2]["unit"]);?></p>
<p>La iluminación: <?php echo round($datos["data"]["sensors"][0]["value"],2);?> <?php echo ($datos["data"]["sensors"][0]["unit"]);?> </p>
<p>El ruido: <?php echo round($datos["data"]["sensors"][7]["value"],2);?> <?php echo ($datos["data"]["sensors"][7]["unit"]);?> </p>
