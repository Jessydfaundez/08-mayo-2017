...
<?php
$json = file_get_contents('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson');
...
<p>Ahora veamos los temblores sobre 4.5, registrados alrededor del mundo en la última semana:</p>
